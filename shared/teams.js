...
export const TEAMS = {
  ...
  ATM: { naam: 'Atlético Madrid', aliases: ['Atlético Madrid','Atletico Madrid','Club Atlético de Madrid','Club Atletico de Madrid','Atleti'], logo: 'https://en.wikipedia.org/wiki/Special:FilePath/Atletico_Madrid_2017_logo.svg' },
  ...
  CLU: { naam: 'Club Brugge', aliases: ['Club Brugge','Club Brugge KV'], logo: 'https://en.wikipedia.org/wiki/Special:FilePath/Club_Brugge_KV_logo.svg' },
  ...
  RMA: { naam: 'Real Madrid', aliases: ['Real Madrid','Real Madrid CF'], logo: 'https://en.wikipedia.org/wiki/Special:FilePath/Real_Madrid_CF.svg' },
